...
import { MapPin, Clock, Car, DollarSign, X } from "lucide-react-native";
...
const ParkingSessionActive = () => {
    ...
    const selectNewZone = (zone) => {
        Alert.alert(
            "Сменить зону",
            `Вы хотите сменить зону на "${zone.name}" (слот ${zone.slot})?`,
            [
                { text: "Отмена", style: "cancel" },
                {
                    text: "Да, сменить",
                    onPress: () => {
                        ...
                        Alert.alert("Успешно", `Вы переместились в зону "${zone.name}" (слот ${zone.slot})`);
                    }
                }
            ]
        );
    ...
    const renderZoneItem = ({ item }) => (
        ...
        >
            ...
            <View className="flex-1">
                ...
                <Text className="font-poppins-medium text-gray-600">Слот: {item.slot} • ${item.rate}/час</Text>
            </View>
            {item.id === currentParkingZone.id && (
                <View className="bg-green-100 px-3 py-1 rounded-full">
                    <Text className="font-poppins-medium text-green-700">Текущая</Text>
                </View>
            )}
        </TouchableOpacity>
    );
        ...
        <>
            <ScrollView className="w-full h-full bg-white">
                <LinearGradient
                    ...
                    <View className={"items-center"}>
                        <View className={"mt-14"}>
                            <Header header={"Активная сессия"} style={"user"} textColor={"white"}/>
                        </View>

                        {/* Анимированный круг с таймером */}
                        <Animated.View
                            className="w-80 h-80 border-8 border-white rounded-full flex items-center justify-center mt-6"
                            style={{
                                transform: [{ scale: animatedValue }],
                            }}>
                            <View>
                                <Text className="text-5xl leading-snug font-poppins-semibold text-white text-center">
                                    {timeElapsed.hours}ч {timeElapsed.minutes}м
                                </Text>
                                <Text className={"text-xl font-poppins-medium text-white text-center"}>
                                    AK 2860 BC
                                </Text>
                                <View className="mt-4 items-center">
                                    <Text className="text-white text-lg font-poppins-medium">Текущая стоимость:</Text>
                                    <Text className="text-white text-3xl font-poppins-semibold">${calculateCurrentCost()}</Text>
                                </View>
                            </View>
                        </Animated.View>
                    </View>

                    <View className="w-full px-6 flex-row justify-between mt-6 mb-2">
                        <TouchableOpacity
                ...
                <View className="px-5 -mt-5">
                    <View className="bg-white rounded-3xl p-5 shadow-md shadow-gray-300 elevation-5">
                        <View className="mb-5 pb-2 border-b border-gray-100">
                            <Text className="text-xl font-poppins-semibold text-gray-800">Детали парковки</Text>
                        </View>
                        ...
                        <View className="space-y-4">
                            <TouchableOpacity
                                ...
                                <View className="flex-1">
                                    <Text className="font-poppins-medium text-gray-600">Парковочная зона</Text>
                                    <Text className="font-poppins-semibold text-gray-800">{currentParkingZone.name}</Text>
                                </View>
                            ...
                            <TouchableOpacity className="flex-row items-center">
                                ...
                                <View className="flex-1">
                                    <Text className="font-poppins-medium text-gray-600">Время въезда</Text>
                                    <Text className="font-poppins-semibold text-gray-800">17:48, 19 Ноя 2025</Text>
                                </View>
                            </TouchableOpacity>
                            ...
                            <TouchableOpacity
                                ...
                                <View className="flex-1">
                                    <Text className="font-poppins-medium text-gray-600">Автомобиль</Text>
                                    <Text className="font-poppins-semibold text-gray-800">Renault Arkana</Text>
                                </View>
                            </TouchableOpacity>
                            ...
                            <TouchableOpacity className="flex-row items-center">
                                ...
                                <View className="flex-1">
                                    <Text className="font-poppins-medium text-gray-600">Тариф</Text>
                                    <Text className="font-poppins-semibold text-gray-800">${currentParkingZone.rate}/час</Text>
                                </View>
                            </TouchableOpacity>
                        </View>

                        <TouchableOpacity
                            className="mt-6 bg-[#3f8efc] rounded-xl py-4 items-center"
                            onPress={handleEndSession}>
                            <Text className="text-white font-poppins-semibold text-lg">Оплатить и завершить</Text>
                        </TouchableOpacity>
                    </View>

                    <View className="mt-6 mb-4 bg-white rounded-3xl p-5 shadow-md shadow-gray-300 elevation-5">
                        <View className="mb-4">
                            <Text className="text-xl font-poppins-semibold text-gray-800">Дополнительные опции</Text>
                        </View>

                        <TouchableOpacity
                            className="flex-row items-center justify-between p-3 bg-gray-50 rounded-xl mb-3"
                            onPress={handleChangeZone}>
                            <View className="flex-row items-center">
                                <View className="w-10 h-10 bg-blue-100 rounded-full items-center justify-center mr-3">
                                    <Feather name="map" size={20} color="#3f8efc" />
                                </View>
                                <Text className="font-poppins-medium text-gray-800">Сменить зону парковки</Text>
                            </View>
                            <Feather name="chevron-right" size={20} color="#9e9e9e" />
                        </TouchableOpacity>
                        ...
                        <TouchableOpacity
                            ...
                            <View className="flex-row items-center">
                                ...
                                <Text className="font-poppins-medium text-gray-800">Сообщить о проблеме</Text>
                            </View>
                            <Feather name="chevron-right" size={20} color="#9e9e9e" />
                        </TouchableOpacity>
                        ...
                        <TouchableOpacity
                            ...
                            onPress={() => Alert.alert("Информация", "Запрос чека")}>
                            <View className="flex-row items-center">
                                <View className="w-10 h-10 bg-blue-100 rounded-full items-center justify-center mr-3">
                                    <Feather name="file-text" size={20} color="#3f8efc" />
                                </View>
                                <Text className="font-poppins-medium text-gray-800">Получить чек</Text>
                            </View>
                            <Feather name="chevron-right" size={20} color="#9e9e9e" />
                        </TouchableOpacity>
                    </View>
                ...
                <View className="flex-1 bg-black/50 justify-end">
                    <View className="bg-white rounded-t-3xl max-h-[70%]">
                        <View className="flex-row justify-between items-center p-5 border-b border-gray-100">
                            <Text className="text-xl font-poppins-semibold text-gray-800">Выберите зону парковки</Text>
                        ...
                        <View className="p-4 border-t border-gray-100">
                            <TouchableOpacity
                                ...
                                <Text className="font-poppins-semibold text-gray-800">Отмена</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                </View>
