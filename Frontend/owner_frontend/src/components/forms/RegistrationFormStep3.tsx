...
const formSchema = z.object({
    ...
    // }),
    // belongToInstitution: z.optional(),
    // termsAccept: z.string().min(2, {
    //     message: "TermsAccept must be at least 2 characters.",
    // }),
...
export function RegistrationFormStep3( ) {
    ...
    async function onSubmit(values :z.infer<typeof formSchema>) {
        try {
            await userStore.processRegistrationStep2({
                city: values.city,
                street: values.street,
                postalCode: values.postalCode,
                houseNumber: values.houseNumber,
                apartmentNumber: values.houseNumber,
