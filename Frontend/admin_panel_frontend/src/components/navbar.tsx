...
import {Bell as NotificationsIcon, ChevronRightIcon, LogOut as LogOutIcon, User as UserIcon} from "lucide-react";
...
const Navbar = () => {
    ...
    const breadcrumbs = [
        ...
        {href: "/dashboard/tags", label: "Reports"},
        {href: "/dashboard/tags/detail", label: "Details"},
    ];
    ...
    return <header className="bg-white shadow p-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-6">
            ...
            >
                ...
                <span
                    className="absolute top-0 right-0 inline-block w-2 h-2 transform translate-x-1/2 -translate-y-1/2 bg-red-500 rounded-full"></span>
            </button>
