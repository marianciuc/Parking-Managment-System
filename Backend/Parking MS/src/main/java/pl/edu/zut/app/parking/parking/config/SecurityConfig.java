        ...
        .authorizeHttpRequests(
            auth ->
                auth.requestMatchers(
                        "/error",
                        "/api/v1/parking/{parkingId" + "}/isParkingAvailable",
                        "/api/v1/parking/{parkingId}",
                        "/api/v1/parking/{parkingId}/owner-id",
                        "/api/v1/parking/{parkingId}/default-currency",
                        "/api/v1/parking/{parkingId}/active-tariff")
                    .permitAll()
                    .anyRequest()
                    .authenticated())
