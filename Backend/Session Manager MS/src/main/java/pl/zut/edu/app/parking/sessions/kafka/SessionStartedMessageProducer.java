...
import pl.zut.edu.app.parking.sessions.kafka.messages.SessionStartedMessage;
...
public class SessionStartedMessageProducer {
   ...
   */
  public void produce(String plateNumber, UUID parkingId, UUID ownerId, LocalDateTime startTime) {
